  ...
  "A Enemy" when {
    "new" should {
      ...
      "be able to check if a Card of the Enemys Card List can be pushed" in{
        newGame.enemy.pushableEnemy(Card(newGame.enemy.enemyCards(4).color, newGame.enemy.enemyCards(4).value), newGame) should be (false)
      }
      "be able to check if a second Card of the Enemys Card List can be pushed" in{
        newGame.enemy.pushableEnemy(Card(newGame.enemy.enemyCards(1).color, newGame.enemy.enemyCards(1).value), newGame) should be (false)
      }


      "be able to check if a third Card of the Enemys Card List can be pushed" in{
        newGame.enemy.pushableEnemy(Card(newGame.enemy.enemyCards(0).color, newGame.enemy.enemyCards(0).value), newGame) should be (true)
      }
      "be able to push a Card of the Enemys Card List" in{
        newGame.enemy.pushCardEnemy(Card(newGame.enemy.enemyCards.head.color, newGame.enemy.enemyCards.head.value), newGame) should be(newGame.enemy)
      }
      ...
      "be able to check if a fifth Card of the Enemys Card List can be pushed" in{
        newGame.enemy.pushableEnemy(Card(newGame.enemy.enemyCards(1).color, newGame.enemy.enemyCards(1).value), newGame) should be (true)
      }
      "be able to push a third Card of the Enemys Card List" in{
        newGame.enemy.pushCardEnemy(Card(newGame.enemy.enemyCards(1).color, newGame.enemy.enemyCards(1).value), newGame) should be(newGame.enemy)
      }
      ...
      "be able to push a fourth Card of the Enemys Card List" in{
        newGame.enemy.pushCardEnemy(Card(newGame.enemy.enemyCards(0).color, newGame.enemy.enemyCards(0).value), newGame) should be(newGame.enemy)
      }


      "be able to check if a seventh Card of the Enemys Card List can be pushed" in{
        newGame.enemy.pushableEnemy(Card(newGame.enemy.enemyCards.head.color, newGame.enemy.enemyCards.head.value), newGame) should be (true)
      }
